...
N = 5
CANT = 10
MUESTRA = [3, 4, 3, 3, 2, 5, 4, 5, 0, 1]

def generator_vector(values, n):
	'''
	Esta funcion, dado un vector de observaciones, genera el vector 
	correspondiente de valores acumulados de las observaciones para 
...
def generator_T_prom(times, value, probs, p):
	...
	for _ in range(times):
		values = generator_v_binomiales(10, N, p)
		vector = generator_vector(values, N)
...
print "valor-p (sim): ", generator_T_prom(500, T, probs, p)